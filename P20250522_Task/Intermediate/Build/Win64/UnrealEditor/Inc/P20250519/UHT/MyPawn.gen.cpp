...
P20250519_API UClass* Z_Construct_UClass_AMyPawn();
P20250519_API UClass* Z_Construct_UClass_AMyPawn_NoRegister();
UPackage* Z_Construct_UPackage__Script_P20250519();
// End Cross Module References

// Begin Class AMyPawn Function DoBoost
struct Z_Construct_UFunction_AMyPawn_DoBoost_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMyPawn_DoBoost_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMyPawn, nullptr, "DoBoost", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMyPawn_DoBoost_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMyPawn_DoBoost_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_AMyPawn_DoBoost()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMyPawn_DoBoost_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AMyPawn::execDoBoost)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->DoBoost();
...
// End Class AMyPawn Function DoBoost

// Begin Class AMyPawn Function Fire
struct Z_Construct_UFunction_AMyPawn_Fire_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "MyPawn.h" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMyPawn_Fire_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMyPawn, nullptr, "Fire", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMyPawn_Fire_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMyPawn_Fire_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_AMyPawn_Fire()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMyPawn_Fire_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AMyPawn::execFire)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->Fire();
...
// End Class AMyPawn Function Fire

// Begin Class AMyPawn Function Pitch
struct Z_Construct_UFunction_AMyPawn_Pitch_Statics
{
	struct MyPawn_eventPitch_Parms
	{
		float AxisValue;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AMyPawn_Pitch_Statics::NewProp_AxisValue = { "AxisValue", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MyPawn_eventPitch_Parms, AxisValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMyPawn_Pitch_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMyPawn_Pitch_Statics::NewProp_AxisValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AMyPawn_Pitch_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMyPawn_Pitch_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMyPawn, nullptr, "Pitch", nullptr, nullptr, Z_Construct_UFunction_AMyPawn_Pitch_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMyPawn_Pitch_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMyPawn_Pitch_Statics::MyPawn_eventPitch_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMyPawn_Pitch_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMyPawn_Pitch_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_AMyPawn_Pitch_Statics::MyPawn_eventPitch_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_AMyPawn_Pitch()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMyPawn_Pitch_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AMyPawn::execPitch)
{
	P_GET_PROPERTY(FFloatProperty,Z_Param_AxisValue);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->Pitch(Z_Param_AxisValue);
	P_NATIVE_END;
}
// End Class AMyPawn Function Pitch

// Begin Class AMyPawn Function Roll
struct Z_Construct_UFunction_AMyPawn_Roll_Statics
{
	struct MyPawn_eventRoll_Parms
	{
		float AxisValue;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AMyPawn_Roll_Statics::NewProp_AxisValue = { "AxisValue", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MyPawn_eventRoll_Parms, AxisValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMyPawn_Roll_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMyPawn_Roll_Statics::NewProp_AxisValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AMyPawn_Roll_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMyPawn_Roll_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMyPawn, nullptr, "Roll", nullptr, nullptr, Z_Construct_UFunction_AMyPawn_Roll_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMyPawn_Roll_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMyPawn_Roll_Statics::MyPawn_eventRoll_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMyPawn_Roll_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMyPawn_Roll_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_AMyPawn_Roll_Statics::MyPawn_eventRoll_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_AMyPawn_Roll()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMyPawn_Roll_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AMyPawn::execRoll)
{
	P_GET_PROPERTY(FFloatProperty,Z_Param_AxisValue);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->Roll(Z_Param_AxisValue);
	P_NATIVE_END;
}
// End Class AMyPawn Function Roll

// Begin Class AMyPawn Function UnBoost
struct Z_Construct_UFunction_AMyPawn_UnBoost_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "MyPawn.h" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMyPawn_UnBoost_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMyPawn, nullptr, "UnBoost", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMyPawn_UnBoost_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMyPawn_UnBoost_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_AMyPawn_UnBoost()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMyPawn_UnBoost_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AMyPawn::execUnBoost)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->UnBoost();
...
// End Class AMyPawn Function UnBoost
...
void AMyPawn::StaticRegisterNativesAMyPawn()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "DoBoost", &AMyPawn::execDoBoost },
		{ "Fire", &AMyPawn::execFire },
		{ "Pitch", &AMyPawn::execPitch },
		{ "Roll", &AMyPawn::execRoll },
		{ "UnBoost", &AMyPawn::execUnBoost },
	};
...
struct Z_Construct_UClass_AMyPawn_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BodyRotateSpeed_MetaData[] = {
		{ "Category", "Data" },
		{ "ModuleRelativePath", "MyPawn.h" },
	};
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_BodyRotateSpeed;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AMyPawn_DoBoost, "DoBoost" }, // 988355899
		{ &Z_Construct_UFunction_AMyPawn_Fire, "Fire" }, // 1058889528
		{ &Z_Construct_UFunction_AMyPawn_Pitch, "Pitch" }, // 3264356419
		{ &Z_Construct_UFunction_AMyPawn_Roll, "Roll" }, // 845696728
		{ &Z_Construct_UFunction_AMyPawn_UnBoost, "UnBoost" }, // 2298041372
	};
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AMyPawn_Statics::NewProp_Movement = { "Movement", nullptr, (EPropertyFlags)0x011400000008000d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMyPawn, Movement), Z_Construct_UClass_UFloatingPawnMovement_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Movement_MetaData), NewProp_Movement_MetaData) };
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_AMyPawn_Statics::NewProp_RocketTemplete = { "RocketTemplete", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMyPawn, RocketTemplete), Z_Construct_UClass_UClass, Z_Construct_UClass_AMyActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RocketTemplete_MetaData), NewProp_RocketTemplete_MetaData) };
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AMyPawn_Statics::NewProp_BodyRotateSpeed = { "BodyRotateSpeed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMyPawn, BodyRotateSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BodyRotateSpeed_MetaData), NewProp_BodyRotateSpeed_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMyPawn_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMyPawn_Statics::NewProp_BodyRotateSpeed,
...
template<> P20250519_API UClass* StaticClass<AMyPawn>()
{
	return AMyPawn::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_UnrealEngineProject_P20250522_Task_Source_P20250519_MyPawn_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMyPawn, AMyPawn::StaticClass, TEXT("AMyPawn"), &Z_Registration_Info_UClass_AMyPawn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyPawn), 173916187U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealEngineProject_P20250522_Task_Source_P20250519_MyPawn_h_2357219597(TEXT("/Script/P20250519"),
	Z_CompiledInDeferFile_FID_UnrealEngineProject_P20250522_Task_Source_P20250519_MyPawn_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealEngineProject_P20250522_Task_Source_P20250519_MyPawn_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
